...
BEGIN
  ...
  -- 2. Upsert members (chặn các email mẫu @example.com và @test.com)
  ...
  -- 4. Upsert folders (chặn triệt để 24 thư mục demo)
  ...
  -- 6. Replace ACL entries with DISTINCT ON safety and demo filtering
  DELETE FROM public.folder_acl_entries
